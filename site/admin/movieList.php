...
<div class="container">
  ...
  <a class="navbar-brand" href="#">Filmlane дээрх кинонууд</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
  	 <ul class="navbar-nav ml-auto">
  	 	      <li class="nav-item">
        <a class="btn btn-warning text-light" href="addmovie.php">Кино нэмэх</a>
      </li>
  	 </ul>
    <ul class="navbar-nav ml-auto">
...
if ($run) {
    ...
    <p><?php echo $row['movie_id']; ?></p>
     <?php echo "<img height='150px' width='200' src='../thumb/".$row['img']."'>"; ?>
      <div class="card-body">
        ...
        <a href="viewmovie.php?id=<?php echo$row['movie_id']; ?>" 
      <br>
      <br>
      <button onclick="myFunction()" class="btn btn-danger">Устгах</button>
      <script>
  ...
  function myFunction() {
    if (confirm("Delete movie ")) {
      ...
      <a href="editmovie.php?movie_id=<?php echo$row['movie_id'] ?>" class="btn btn-info ">Засах</a>
</div>
